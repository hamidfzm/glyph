...
*Try pressing `Cmd+F` to search this document, or `Cmd+P` to print / save as PDF. Use `File → Export` to save this page as HTML, Word (DOCX), or EPUB — math, code highlighting, tables, and images are carried straight from the rendered view.*
