...
- New workspace: File → New Workspace… (or the empty-state button / command palette) names and creates an empty folder, then opens it as the window's workspace, ready for new notes
