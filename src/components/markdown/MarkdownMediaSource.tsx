...
interface MarkdownMediaSourceProps extends ComponentPropsWithoutRef<"source"> {
...
export function MarkdownMediaSource({ filePath, src, ...rest }: MarkdownMediaSourceProps) {
