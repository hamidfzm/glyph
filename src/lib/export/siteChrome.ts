// The CSS and JavaScript a standalone or multi-page export ships alongside the
// rendered markdown: layout overrides, the dark-mode toggle, the site nav and
