...
// Only fully-translated locales belong here; the set mirrors the marketing
// site's languages. Persian (fa) is RTL (dir="rtl"); the broader RTL layout
// audit is tracked in #264.
